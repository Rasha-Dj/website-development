<template>
    <div class="contact section-padding" id="section-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-4">
                    <div class="part-info">
                        <div class="info-box">
                            <div class="icon">
                                <font-awesome-icon icon="phone" size="lg" style="color: #ab2f52"></font-awesome-icon>
                            </div>
                            <div class="content">
                                <h4>Phone :</h4>
                                <p>0123456789</p>
                        ...
                        <div class="info-box">
                            <div class="icon">
                                <font-awesome-icon icon="map-marker-alt" size="lg" style="color: #ab2f52"></font-awesome-icon>
                            </div>
                            <div class="content">
                                <h4>Address :</h4>
                                <p>New Delhi, India</p>
                        ...
                        <div class="info-box">
                            <div class="icon">
                                <font-awesome-icon icon="envelope" size="lg" style="color: #ab2f52"></font-awesome-icon>
                            </div>
                            <div class="content">
                                <h4>Mail :</h4>
